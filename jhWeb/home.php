...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">TwinKers</a>
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <?php 
        if(isset($_SESSION['loggedin'])){
          echo '<h5>What are you waiting for '
          .$Name.'!</h5>
          <a href="./index.php" class="btn btn-primary">Take Notes</a>
          ';
        }else{
          echo '  <h5>Start Taking Notes Today!</h5>
          <a href="./session/signup.php" class="btn btn-primary">Join Now!</a>';
        }
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption  d-block">
        <h5>Got something on mind?<br> Write it down!</h5>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption  d-block">
        <h5>Don't have a Pen? </h5>
        <p>No Problem! Use Twinkers</p>
      </div>
    </div>
  </div>
...
<div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <p class="lead">You notes are saved in a secured place . Nobody can read them</p>
      </div>
      <div class="col-md-5">
